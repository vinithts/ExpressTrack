    ...
    return (
        <div className='about'>
            <div className="container">
                <h2>Comprehensive logistics and transportation solution</h2>
                <p>Worldwide Services: Courier, Logistics, Express, Shipping, Freight Forwarders in Dubai, UAE</p>
                ...
                <a href="/" className="btn">Get it Touch</a>
            </div>
        </div>
    )
}
